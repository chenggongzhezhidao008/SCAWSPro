#ifndef WaringLogInforCtx_H
#define WaringLogInforCtx_H
...
class WaringLogInforCtx : public QWidget
{
    Q_OBJECT
...
public:
    explicit WaringLogInforCtx(QWidget *parent = 0);
